...
#include "Lab1.h"
  ...
  JNIEXPORT jdouble JNICALLJava_Prueba_nativeRead(JNIEnv *env, jobject obj, jintArray array) { //we define the function that calls the function previously defined in the java program
